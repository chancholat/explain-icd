...
class RobertaSelfAttention(nn.Module):
    ...
    def forward(
        ...
        output_norms: Optional[bool] = False,  # added by chancholat, ref from Goro Kobayashi
        ...
        # added below by chan, ref from Goro Kobayashi
        #-------------------------------
        if output_norms:
...
# Copied from transformers.src.transformers.modeling_bert.BertNormOutput with Bert->Roberta
# Author: Goro Kobayashi, added by chancholat
...
class RobertaAttention(nn.Module):
    ...
    def forward(
        ...
        self_outputs = self.self(
            ...
            past_key_value,
            output_attentions,
            output_norms,  # added by chancholat, ref from Goro Kobayashi
        )
        attention_output = self.output(self_outputs[0], hidden_states)

        # changed below by Goro Kobayashi, added by chancholat
        #-------------------------------
        if output_norms:
...
class RobertaLayer(nn.Module):
    ...
    def forward(
        ...
        self_attention_outputs = self.attention(
            ...
            output_norms=output_norms,  # added by chancholat, ref from Goro Kob
        )
...
class RobertaEncoder(nn.Module):
    ...
    def forward(
        ...
        all_norms = () if output_norms else None  # added by chancholat, ref from Goro Kobayashi
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            # added by chancholat, ref from Goro Kobayashi
            if output_norms:
        ...
        if not return_dict:
            return tuple(
                ...
                for v in [
                    ...
                    all_norms, # added by chancholat, ref from Goro Kobayashi
                ]
                if v is not None
            )
...
class RobertaModel(RobertaPreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs = self.encoder(
            ...
            output_norms=output_norms,  # added by chancholat, ref from Goro Kobayashi
        )
